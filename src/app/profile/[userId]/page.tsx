      ...
      <main className="flex-grow container mx-auto p-4 md:p-8">
        {profileUser && (
            ...
            <div className="flex-grow text-center sm:text-left">
                <h1 className="text-3xl md:text-4xl font-headline font-bold">{profileUser.displayName}</h1>
                <p className="text-base md:text-lg text-muted-foreground">{profileUser.email}</p>
            </div>
             {isOwnProfile && (
        ...
        <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl md:text-3xl font-headline">Book Lists</h2>
            {isOwnProfile && (
